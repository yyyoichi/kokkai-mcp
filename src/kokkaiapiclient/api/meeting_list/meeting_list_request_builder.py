...
if TYPE_CHECKING:
    ...
    from .meeting_list_get_response import Meeting_listGetResponse

class Meeting_listRequestBuilder(BaseRequestBuilder):
    """
    Builds and executes requests for operations under /api/meeting_list
    """
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Union[str, dict[str, Any]]) -> None:
        """
        Instantiates a new Meeting_listRequestBuilder and sets the default values.
        param path_parameters: The raw url or the url-template parameters for the request.
        param request_adapter: The request adapter to use to execute the requests.
        Returns: None
        """
        super().__init__(request_adapter, "{+baseurl}/api/meeting_list{?any,closing,contentsAndIndex,from,issueFrom,issueID,issueTo,maximumRecords,nameOfHouse,nameOfMeeting,recordPacking,searchRange,sessionFrom,sessionTo,speaker,speakerGroup,speakerPosition,speakerRole,speechID,speechNumber,startRecord,supplementAndAppendix,until}", path_parameters)
    
    async def get(self,request_configuration: Optional[RequestConfiguration[Meeting_listRequestBuilderGetQueryParameters]] = None) -> Optional[Meeting_listGetResponse]:
        """
        会議単位簡易出力
        param request_configuration: Configuration for the request such as headers, query parameters, and middleware options.
        Returns: Optional[Meeting_listGetResponse]
        """
        ...
        return await self.request_adapter.send_async(request_info, Meeting_listGetResponse, None)
    
    def to_get_request_information(self,request_configuration: Optional[RequestConfiguration[Meeting_listRequestBuilderGetQueryParameters]] = None) -> RequestInformation:
        """
        会議単位簡易出力
        param request_configuration: Configuration for the request such as headers, query parameters, and middleware options.
    ...
    def with_url(self,raw_url: str) -> Meeting_listRequestBuilder:
        """
        Returns a request builder with the provided arbitrary URL. Using this method means any other path or query parameters are ignored.
        param raw_url: The raw URL to use for the request builder.
        Returns: Meeting_listRequestBuilder
        """
        if raw_url is None:
            raise TypeError("raw_url cannot be null.")
        return Meeting_listRequestBuilder(self.request_adapter, raw_url)
    
    @dataclass
    class Meeting_listRequestBuilderGetQueryParameters():
        """
        会議単位簡易出力
        """
    ...
    @dataclass
    class Meeting_listRequestBuilderGetRequestConfiguration(RequestConfiguration[Meeting_listRequestBuilderGetQueryParameters]):
        """
