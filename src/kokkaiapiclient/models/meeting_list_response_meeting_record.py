...
if TYPE_CHECKING:
    ...
    from .meeting_list_response_meeting_record_closing import MeetingListResponse_meetingRecord_closing
    from .meeting_list_response_meeting_record_pdf_u_r_l import MeetingListResponse_meetingRecord_pdfURL
    from .meeting_list_speech_record import MeetingListSpeechRecord
    from .name_of_house import NameOfHouse

@dataclass
class MeetingListResponse_meetingRecord(AdditionalDataHolder, Parsable):
    # Stores additional data not described in the OpenAPI description found when deserializing. Can be used for serialization as well.
    additional_data: dict[str, Any] = field(default_factory=dict)

    # 閉会中フラグ。
    closing: Optional[MeetingListResponse_meetingRecord_closing] = None
    # 開催日付 (YYYY-MM-DD)。
    ...
    # 会議録PDF表示画面へのURL。
    pdf_u_r_l: Optional[MeetingListResponse_meetingRecord_pdfURL] = None
    # 検索対象箇所。
    search_object: Optional[int] = None
    # 国会回次。
    session: Optional[int] = None
    # 発言リスト。
    speech_record: Optional[list[MeetingListSpeechRecord]] = None
    
    @staticmethod
    def create_from_discriminator_value(parse_node: ParseNode) -> MeetingListResponse_meetingRecord:
        """
        Creates a new instance of the appropriate class based on discriminator value
        param parse_node: The parse node to use to read the discriminator value and create the object
        Returns: MeetingListResponse_meetingRecord
        """
        if parse_node is None:
            raise TypeError("parse_node cannot be null.")
        return MeetingListResponse_meetingRecord()
    ...
    def get_field_deserializers(self,) -> dict[str, Callable[[ParseNode], None]]:
        ...
        fields: dict[str, Callable[[Any], None]] = {
            "closing": lambda n : setattr(self, 'closing', n.get_object_value(MeetingListResponse_meetingRecord_closing)),
            ...
            "pdfURL": lambda n : setattr(self, 'pdf_u_r_l', n.get_object_value(MeetingListResponse_meetingRecord_pdfURL)),
            "searchObject": lambda n : setattr(self, 'search_object', n.get_int_value()),
            "session": lambda n : setattr(self, 'session', n.get_int_value()),
            "speechRecord": lambda n : setattr(self, 'speech_record', n.get_collection_of_object_values(MeetingListSpeechRecord)),
        }
        return fields
