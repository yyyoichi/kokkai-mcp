...
if TYPE_CHECKING:
    ...
    from .speech_get_response import SpeechGetResponse

class SpeechRequestBuilder(BaseRequestBuilder):
    """
    Builds and executes requests for operations under /api/speech
    """
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Union[str, dict[str, Any]]) -> None:
        ...
        Returns: None
        """
        super().__init__(request_adapter, "{+baseurl}/api/speech{?any,closing,contentsAndIndex,from,issueFrom,issueID,issueTo,maximumRecords,nameOfHouse,nameOfMeeting,recordPacking,searchRange,sessionFrom,sessionTo,speaker,speakerGroup,speakerPosition,speakerRole,speechID,speechNumber,startRecord,supplementAndAppendix,until}", path_parameters)
    
    async def get(self,request_configuration: Optional[RequestConfiguration[SpeechRequestBuilderGetQueryParameters]] = None) -> Optional[SpeechGetResponse]:
        """
        発言単位出力
        param request_configuration: Configuration for the request such as headers, query parameters, and middleware options.
        Returns: Optional[SpeechGetResponse]
        """
        ...
        return await self.request_adapter.send_async(request_info, SpeechGetResponse, None)
    
    def to_get_request_information(self,request_configuration: Optional[RequestConfiguration[SpeechRequestBuilderGetQueryParameters]] = None) -> RequestInformation:
        """
        発言単位出力
        param request_configuration: Configuration for the request such as headers, query parameters, and middleware options.
    ...
    def with_url(self,raw_url: str) -> SpeechRequestBuilder:
        """
        Returns a request builder with the provided arbitrary URL. Using this method means any other path or query parameters are ignored.
        param raw_url: The raw URL to use for the request builder.
        Returns: SpeechRequestBuilder
        """
        if raw_url is None:
            raise TypeError("raw_url cannot be null.")
        return SpeechRequestBuilder(self.request_adapter, raw_url)
    
    @dataclass
    class SpeechRequestBuilderGetQueryParameters():
        """
        発言単位出力
        """
    ...
    @dataclass
    class SpeechRequestBuilderGetRequestConfiguration(RequestConfiguration[SpeechRequestBuilderGetQueryParameters]):
        """
